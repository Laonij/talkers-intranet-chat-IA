...
function buildIntranetWorkspace({ user, departments = [], recentDocuments = [], totalDocuments = 0, salesWorkspace = null }) {
  ...
  return {
    ...
    communication: {
      mural: [
        ...
        ...(salesEnabled
          ? [{ title: 'Operacao comercial viva', description: 'As matriculas importadas podem evoluir dentro da intranet com status, observacoes e historico auditavel.' }]
          : []),
      ],
    },
    admin: {
