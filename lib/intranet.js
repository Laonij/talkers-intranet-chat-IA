...
const DEPARTMENT_SUBMENU_DEFINITIONS = [
  {
    departmentSlug: 'atendimento',
    title: 'Busca de aluno',
    slug: 'busca-aluno',
    description: 'Pesquisa rápida por nome, CPF, contato, responsável ou matrícula para localizar a ficha 360 do aluno.',
    icon: 'search',
    viewKey: 'student-search',
    sortOrder: 10,
    isActive: true,
    metadata: {
      module: 'student_search',
      intranet_view: 'student-hub',
      student_flow_scope: 'attendance',
    },
  },
  {
    departmentSlug: 'atendimento',
    ...
    slug: 'ficha-aluno',
    description: 'Visão 360 do aluno com dados cadastrais, responsáveis, matrícula, financeiro e resumo pedagógico.',
    icon: 'users',
    viewKey: 'student-profile',
    sortOrder: 20,
    isActive: true,
    metadata: {
      module: 'student_profile_360',
      intranet_view: 'student-hub',
      student_flow_scope: 'attendance',
    },
  },
  {
    ...
    slug: 'atendimento-historico',
    description: 'Linha do tempo com eventos relevantes do aluno, contatos, conversão, contrato e ocorrências operacionais.',
    icon: 'list',
    viewKey: 'student-history',
    sortOrder: 30,
    isActive: true,
    metadata: {
      module: 'student_service_history',
      intranet_view: 'student-hub',
      student_flow_scope: 'attendance',
    },
  },
  {
    departmentSlug: 'comercial',
    title: 'Leads',
    slug: 'leads',
    description: 'Leads comerciais com origem, idioma, modalidade, negociação e prontidão para conversão em aluno.',
    icon: 'target',
    viewKey: 'commercial-leads',
    sortOrder: 10,
    isActive: true,
    metadata: {
      module: 'commercial_leads',
      intranet_view: 'student-hub',
      student_flow_scope: 'commercial',
    },
  },
  {
    departmentSlug: 'comercial',
    title: 'Negociações',
    slug: 'negociacoes',
    description: 'Acompanhamento das negociações comerciais, observações, atendente e etapa do fechamento.',
    icon: 'briefcase',
    viewKey: 'commercial-negotiations',
    sortOrder: 20,
    isActive: true,
    metadata: {
      module: 'commercial_negotiations',
      intranet_view: 'student-hub',
      student_flow_scope: 'commercial',
    },
  },
  {
    ...
    slug: 'matriculas-comerciais',
    description: 'Conversão do lead em aluno com criação de cadastro, responsáveis, matrícula e base contratual/financeira.',
    icon: 'file-text',
    viewKey: 'commercial-enrollment-conversion',
    sortOrder: 30,
    isActive: true,
    metadata: {
      module: 'commercial_enrollment_conversion',
      intranet_view: 'student-hub',
      student_flow_scope: 'commercial',
    },
  },
  {
    ...
    title: 'Pós-venda',
    slug: 'pos-venda',
    description: 'Carteira operacional das closers com acompanhamento, feedback, próximas ações e histórico do pós-venda.',
    icon: 'target',
    viewKey: 'sales-post-sale',
    sortOrder: 40,
    isActive: true,
    metadata: {
      module: 'commercial_post_sale',
      intranet_view: 'sales',
      allow_closer_scope: true,
    },
  },
  {
    ...
    title: 'Contratos',
    slug: 'contratos',
    description: 'Base contratual do aluno com responsável financeiro, total, parcelas e situação atual.',
    icon: 'file-text',
    viewKey: 'financial-contracts',
    sortOrder: 10,
    isActive: true,
    metadata: {
      module: 'financial_contracts',
      intranet_view: 'student-hub',
      student_flow_scope: 'financial',
    },
  },
  {
    departmentSlug: 'financeiro',
    title: 'Parcelas',
    slug: 'parcelas',
    description: 'Controle operacional de parcelas, vencimentos, status e atualizações financeiras dos alunos.',
    icon: 'calendar',
    viewKey: 'financial-installments',
    sortOrder: 20,
    isActive: true,
    metadata: {
      module: 'financial_installments',
      intranet_view: 'student-hub',
      student_flow_scope: 'financial',
    },
  },
  {
    ...
    title: 'Recebimentos',
    slug: 'recebimentos',
    description: 'Visão financeira focada nas parcelas pagas, recebidas e em conciliação operacional.',
    icon: 'wallet',
    viewKey: 'financial-receivables',
    sortOrder: 30,
    isActive: true,
    metadata: {
      module: 'financial_receivables',
      intranet_view: 'student-hub',
      student_flow_scope: 'financial',
    },
  },
  {
    ...
    title: 'Inadimplência',
    slug: 'inadimplencia',
    description: 'Carteira de parcelas vencidas, pendências financeiras e acompanhamento da inadimplência.',
    icon: 'flag',
    viewKey: 'financial-delinquency',
    sortOrder: 40,
    isActive: true,
    metadata: {
      module: 'financial_delinquency',
      intranet_view: 'student-hub',
      student_flow_scope: 'financial',
    },
  },
  {
    ...
    slug: 'ficha-financeira',
    description: 'Resumo financeiro do aluno dentro da ficha 360, com contrato, parcelas, vencimentos e histórico básico.',
    icon: 'credit-card',
    viewKey: 'financial-student-profile',
    sortOrder: 50,
    isActive: true,
    metadata: {
      module: 'financial_student_profile',
      intranet_view: 'student-hub',
      student_flow_scope: 'financial',
    },
  },
  ...
  },
  {
    ...
    title: 'Alunos',
    slug: 'alunos',
    description: 'Cadastro principal dos alunos, responsáveis e situação acadêmica dentro do módulo escolar.',
    icon: 'users',
    viewKey: 'academic-students',
    sortOrder: 20,
    isActive: true,
    metadata: {
      module: 'academic_students',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    departmentSlug: 'pedagogico',
    title: 'Matrículas',
    slug: 'matriculas',
    description: 'Fluxo de matrícula, status acadêmico, vínculo com turma e acompanhamento da jornada escolar.',
    icon: 'file-text',
    viewKey: 'academic-enrollments',
    sortOrder: 30,
    isActive: true,
    metadata: {
      module: 'academic_enrollments',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    ...
    title: 'Turmas',
    slug: 'turmas',
    description: 'Gestão de turmas, alunos matriculados, capacidade, professores vinculados e contexto da turma.',
    icon: 'school',
    viewKey: 'academic-classes',
    sortOrder: 40,
    isActive: true,
    metadata: {
      module: 'academic_classes',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    ...
    title: 'Horários',
    slug: 'horarios',
    description: 'Configuração de horários das turmas e visão das janelas acadêmicas por dia da semana.',
    icon: 'clock',
    viewKey: 'academic-schedules',
    sortOrder: 50,
    isActive: true,
    metadata: {
  ...
  {
    departmentSlug: 'pedagogico',
    title: 'Professores/Turmas',
    slug: 'professores-turmas',
    description: 'Vínculos professor ↔ turma, distribuição de carga e visão operacional das alocações.',
    icon: 'briefcase',
    viewKey: 'academic-teachers',
    sortOrder: 60,
    isActive: true,
    metadata: {
      module: 'academic_teacher_assignments',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    ...
    title: 'Frequência',
    slug: 'frequencia',
    description: 'Sessões previstas, chamada por turma e acompanhamento da frequência dos alunos.',
    icon: 'check',
    viewKey: 'academic-attendance',
    sortOrder: 70,
    isActive: true,
    metadata: {
      module: 'academic_attendance',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    departmentSlug: 'pedagogico',
    title: 'Movimentações acadêmicas',
    slug: 'movimentacoes-academicas',
    description: 'Histórico de mudanças de turma, horário e demais movimentações acadêmicas relevantes.',
    icon: 'list',
    viewKey: 'academic-movements',
    sortOrder: 80,
    isActive: true,
    metadata: {
      module: 'academic_movements',
      intranet_view: 'academic',
      academic_scope: 'pedagogical',
    },
  },
  {
    departmentSlug: 'professor',
    title: 'Minhas Turmas',
    slug: 'minhas-turmas',
    description: 'Turmas vinculadas ao professor logado com visão rápida de alunos, horários e sessões.',
    icon: 'school',
    viewKey: 'teacher-classes',
    sortOrder: 10,
    isActive: true,
    metadata: {
      module: 'teacher_classes',
      intranet_view: 'academic',
      academic_scope: 'teacher',
    },
  },
  {
    departmentSlug: 'professor',
    title: 'Chamada',
    slug: 'chamada',
    description: 'Lançamento de presença, faltas e observações das aulas das próprias turmas.',
    icon: 'clipboard',
    viewKey: 'teacher-attendance',
    sortOrder: 20,
    isActive: true,
    metadata: {
  ...
  },
  {
    ...
    slug: 'alunos-da-turma',
    description: 'Relação de alunos por turma com dados básicos, responsáveis e observações pedagógicas.',
    icon: 'users',
    viewKey: 'teacher-class-students',
    sortOrder: 30,
    isActive: true,
    metadata: {
      module: 'teacher_class_students',
      intranet_view: 'academic',
      academic_scope: 'teacher',
    },
  },
...
function buildIntranetWorkspace({
  ...
  if (salesEnabled) {
    uniqueModules.unshift({
      ...
      title: 'Pós-venda por closer',
      description: 'Carteiras de pós-venda com status operacional, follow-up e prioridades do dia.',
      type: 'workspace',
      icon: 'target',
  ...
  if (salesEnabled) {
    updates.unshift({
      title: 'Pós-venda integrado',
      description: 'A carteira importada segue na intranet com acompanhamento, histórico e responsabilidade por closer.',
      label: `${Number(salesWorkspace?.summary?.total || 0)} registro(s)`,
    });
  }
  ...
  if (salesEnabled) {
    quickLinks.unshift({
      title: 'Pós-venda',
      description: 'Closers, feedbacks, próximas ações e histórico operacional.',
      routeKey: 'sales',
      style: 'primary',
    });
  }
  ...
  return {
    permissions: {
      allowed_global_views: Array.isArray(permissionHints.allowed_global_views) ? permissionHints.allowed_global_views : [],
      allowed_department_slugs: Array.isArray(permissionHints.allowed_department_slugs) ? permissionHints.allowed_department_slugs : [],
      allowed_submenu_view_keys: Array.isArray(permissionHints.allowed_submenu_view_keys) ? permissionHints.allowed_submenu_view_keys : [],
      restricted_post_sale_scope: Boolean(permissionHints.restricted_post_sale_scope),
    },
    home: {
