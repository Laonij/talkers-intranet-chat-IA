...
const DEPARTMENT_DEFINITIONS = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: 'pessoas', title: 'Comunicação com pessoas', description: 'Avisos internos, comunicados e apoio com IA.', type: 'assistant' },
    ],
  },
  {
    slug: 'comercial',
  ...
  },
  {
    ...
    modules: [
      ...
      { key: 'analises', title: 'Análises e leituras', description: 'Apoio da IA para interpretar indicadores e apontar oportunidades.', type: 'assistant' },
    ],
  },
  {
    slug: 'financeiro',
    ...
    modules: [
      ...
      { key: 'analises', title: 'Análises com IA', description: 'Apoio para resumos e interpretação financeira.', type: 'assistant' },
    ],
  },
  {
    slug: 'marketing',
    ...
    modules: [
      ...
      { key: 'assets', title: 'Assets e criação', description: 'Peças, materiais e apoio criativo com IA.', type: 'assistant' },
    ],
  },
  {
    slug: 'ti',
  ...
  },
  {
    ...
    modules: [
      ...
      { key: 'pareceres', title: 'Pareceres com IA', description: 'Apoio para localizar cláusulas e resumir materiais.', type: 'assistant' },
    ],
  },
  {
    slug: 'operacoes',
    ...
    modules: [
      ...
      { key: 'gargalos', title: 'Gargalos e melhorias', description: 'Análise operacional com apoio da IA.', type: 'assistant' },
    ],
  },
  {
    slug: 'produto',
...
function buildGenericDepartmentModules(departmentName = '') {
  ...
  return [
    ...
    { key: 'assistente', title: `Assistente de ${safeName}`, description: 'Apoio da IA para dúvidas, resumos e demandas do departamento.', type: 'assistant' },
  ];
}
  ...
  return {
    ...
    cards: [
      ...
      },
      {
        ...
        description: `${recentAvailable} arquivo(s) recentes já disponíveis para IA.`,
      },
      {
